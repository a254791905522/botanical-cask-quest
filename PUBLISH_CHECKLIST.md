...
- [x] Verify CFBundleIdentifier = com.rosewood.botanicalcaskquest.game
- [x] Verify CFBundleDisplayName = Botanical Cask Quest
- [x] Verify UIDeviceFamily = 1

## 11. GitHub/Vercel Deployment
- [x] Push publish/BotanicalCaskQuest/ to GitHub (gh account: a254791905522, repo: botanical-cask-quest)
- [x] Use proxy 127.0.0.1:7897
- [x] Vercel deployed: https://botanical-cask-quest.vercel.app
